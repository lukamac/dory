...
// Global Variables
static pi_buffer_t buffer_streamer;
...
void application(void * args) {
  ...
  pi_buffer_init(&buffer_streamer, PI_BUFFER_TYPE_L2, l2_buffer);
  pi_buffer_set_format(&buffer_streamer, STREAM_WIDTH, STREAM_HEIGHT, 1,
...
// ==========================================================================
  ...
  for (int iter = 0; iter < 100000; iter++) {
    ...
    pi_camera_control(&camera, PI_CAMERA_CMD_START, 0);
    pi_camera_capture(&camera, l2_buffer, BUFF_SIZE);
    pi_camera_control(&camera, PI_CAMERA_CMD_STOP, 0);

#ifdef JPEG_STREAMER
    frame_streamer_send(streamer, &buffer_streamer);
#endif
