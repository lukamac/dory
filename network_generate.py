...
if __name__ == '__main__':
    ...
    Hardware_targets = ["PULP.GAP8", "PULP.GAP8_loop_test", "PULP.GAP8_drone", "PULP.GAP8_L2", "PULP.PULP_gvsoc", "PULP.GAP9", "PULP.GAP9_NE16", "Occamy", "Diana.Diana_TVM", "Diana.Diana_SoC"]
